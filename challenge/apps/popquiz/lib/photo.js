// A photo of a training page: checked on the way in, read once by the model,
// dropped.
//
...
// survives is the proposed questions the manager reviews and chooses to
// publish. Same read-once rule as Rave's screenshots and Chaser's invoices.
...
function validate(raw) {
  if (!raw || typeof raw !== 'object') throw httpError(400, 'Add a photo of the page.');
