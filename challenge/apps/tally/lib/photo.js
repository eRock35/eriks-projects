// One photo of the terminal's end-of-day report (the Z-report or batch
// report): checked on the way in, read once by the model, dropped.
//
...
// survives is the four numbers the owner checks and saves by hand. A Z-report
// can carry a merchant id, a terminal id and staff names; the photo of it is
// not ours to keep. Same read-once rule as Booth's card photos and Receipt's
// whiteboards.
...
function validate(raw) {
  if (!raw || typeof raw !== 'object') throw httpError(400, 'Add a photo of the end-of-day report.');
