// A photo of a business card or a conference badge: checked on the way in,
// read once by the model, dropped.
//
...
// survives is the proposed contact the rep checks and chooses to save. A card
// is somebody's personal data; the photo of it is not ours to keep. Same
// read-once rule as Glowup's screenshots and Pop Quiz's binder photos.
...
function validate(raw) {
  if (!raw || typeof raw !== 'object') throw httpError(400, 'Add a photo of the card or badge.');
