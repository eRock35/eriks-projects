// A review screenshot: checked on the way in, read once by the model, dropped.
//
...
// survives is the proposed review the person checks and chooses to save. Same
// read-once rule as Chaser's invoice snaps and trip-planner's receipts.
...
function validate(raw) {
  if (!raw || typeof raw !== 'object') throw httpError(400, 'Add a screenshot of the review.');
